  ...
  return (
    <>
      <div className="projectsCard">
        <div className="projectsCard_text">
          <div className="projectsCard_heading">
          ...
          <div className="projectsCard_description">
            {props.description}
          </div>
          <div className="projectsCard_techs">
            {props.techs}
          </div>
          <Link to={props.link}>
            <svg
        ...
        <img className='project_img image-fluid' src={props.img} alt="" />
      </div>
    </>
  )
}
